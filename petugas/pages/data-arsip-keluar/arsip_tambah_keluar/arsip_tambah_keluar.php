                ...
                <div class="panel panel">
                    <div class="panel-body">
                        ...
                        <div class="pull-right">
                            <a href="?q=data-arsip-keluar" class="btn btn-sm btn-primary" style="margin-bottom:20px"><i
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <form method="post" action="?q=arsip_aksi_keluar" enctype="multipart/form-data">
