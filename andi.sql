...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2023 at 01:34 PM
...
(8, 'Samsul Bahri', 'user1', '24c9e15e52afc47c225b757e7bee1f9d', '1778760614_wallpaperflare.com_wallpaper.jpg'),
...
--
ALTER TABLE `arsip`
  MODIFY `arsip_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `arsip_keluar`
--
ALTER TABLE `arsip_keluar`
  MODIFY `arsip_keluar_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
